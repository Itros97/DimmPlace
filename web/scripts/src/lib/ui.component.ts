...
export class UIComponent {
  ...
  public appendChild(child: UIComponent | HTMLElement): UIComponent {
    this.element.appendChild(
      child instanceof UIComponent ? child.element : child,
    );
    return this;
  }
   ...
   */
  public setAttributes(options: { [key: string]: string }): UIComponent {
   ...
   */
  public removeAttributes(options: string[]): UIComponent {
   ...
   *   });
   */
  public setDataset(dataset: { [key: string]: string }): UIComponent {
   ...
   */
  public removeDataset(dataset: string[]): UIComponent {
   ...
   */
  public removeEvents(events: string[]): UIComponent {
   ...
   * });
   */
  public setStyles(styles: { [key: string]: string }): UIComponent {
   ...
   */
  public removeStyles(styles: string[]): UIComponent {
   ...
   */
  public setClasses(classes: string[]): UIComponent {
   ...
   */
  public removeClasses(classes: string[]): UIComponent {
